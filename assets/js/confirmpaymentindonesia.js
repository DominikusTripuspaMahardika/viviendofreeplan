...
async function showPaymentNotification(event, productPrice) {
  ...
  notification.innerHTML = `
      ...
      <input readonly id="promo-code" type="text" placeholder="Enter promo code" style="margin: 10px 0; padding: 8px; width: 80%; border: 1px solid #ccc; border-radius: 5px; width: 100%;" ${purchaseCount >= 5 ? 'disabled' : ''}/>
